...
width = 481;
height = 321;
z = get_matrix('Jaguar.raw',481,321,1);
g(:,:,1) = get_matrix('Jaguar_gt1.raw',481,321,0); 
g(:,:,2) = get_matrix('Jaguar_gt2.raw',481,321,0);
g(:,:,3) = get_matrix('Jaguar_gt3.raw',481,321,0);
g(:,:,4) = get_matrix('Jaguar_gt4.raw',481,321,0);
g(:,:,5) = get_matrix('Jaguar_gt5.raw',481,321,0);
g(:,:,6) = get_matrix('Jaguar_gt6.raw',481,321,0);
...
imwrite(255-edge_image,'Thresholded_jaguar_8.png')
% figure
% imshow(g);
